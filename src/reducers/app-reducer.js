...
const initialState = {
	...
	sets: {
		lights: [
			...
			{ name: 'Candles', desc: '', target: 'candles', icon: 'leaf' },
			{ name: 'Rainbow', desc: '', target: 'rainbow', icon: 'leaf' },
			...
			{ name: 'Night', desc: '', target: 'night', icon: 'water' },
			{ name: 'Sunny', desc: '', target: 'sunny', icon: 'water' },
			{ name: 'Sunset', desc: '', target: 'sunset', icon: 'water' },
		],
		music: [
			{ name: 'Off', desc: '', target: 'off', icon: 'off' },
